    ...
    if (AVAILABLE_BLOGS.includes(location.pathname.split('/')[2])) {
        return (
            ...
            <div class='content'>
                ...
                <p>I could have merely interpreted this experience as fixing my laptop to save a few dollars. Instead it represented a gateway for tackling more difficult problems. The first step is curiosity, the second step is learning, and the last step is using that knowledge to solve the issue. This triumph has fueled my ambition to provide modern day solutions to modern day problems.</p>
